        ...
        {tabs.map(tab => {
          ...
          return (
            <button
              ...
              title={tab.label}
              className={`w-full flex items-center justify-center lg:justify-start gap-3 px-2 lg:px-3 py-2.5 rounded-xl transition-all ${
                isActive 
                  ? 'bg-[#FFF0E5] text-[#F37042]' 
                  : 'text-[#6D5A4E] hover:bg-[#FAF0E8]'
              }`}
            >
              <div className={`p-1.5 rounded-lg shrink-0 ${isActive ? 'bg-white shadow-sm' : 'bg-transparent'}`}>

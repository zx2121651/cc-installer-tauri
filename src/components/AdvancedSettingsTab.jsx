...
export default function AdvancedSettingsTab({ configData, saveConfig }) {
  ...
  const [maxThinkingTokens, setMaxThinkingTokens] = useState(configData.max_thinking_tokens);
  const [maxOutputTokens, setMaxOutputTokens] = useState(configData.max_output_tokens);
  const [maxContextLength, setMaxContextLength] = useState(configData.max_context_length);
  ...
  useEffect(() => {
    ...
    setMaxThinkingTokens(configData.max_thinking_tokens);
    setMaxOutputTokens(configData.max_output_tokens);
    setMaxContextLength(configData.max_context_length);
  ...
  const handleSave = () => {
    const updated = {
      ...
      max_thinking_tokens: parseInt(maxThinkingTokens, 10),
      max_output_tokens: parseInt(maxOutputTokens, 10),
      max_context_length: parseInt(maxContextLength, 10),
